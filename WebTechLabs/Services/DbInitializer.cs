    ...
    public static class DbInitializer
    {
        public static async Task Seed(this WebApplication app)
        {
            ...
            if (!context.Dishes.Any())
            {
                ...
                new List<Dish>
                {
                    new Dish { DishName="Суп-харчо", Description="Очень острый, невкусный", Calories =200, DishGroupId=3, Image="1.png" },
                    new Dish { DishName="Борщ", Description="Много сала, без сметаны", Calories =330, DishGroupId=3, Image="4.png" },
                    new Dish { DishName="Суп 1", Description="", Calories =330, DishGroupId=3, Image="2.png" },
                    new Dish { DishName="Суп 2", Description="", Calories =330, DishGroupId=3, Image="3.png" },
